...
"production" !== process.env.NODE_ENV &&
  (function () {
    function JSCompiler_object_inline_createNodeMock_1022() {
      return null;
    }
    ...
    function updateClassComponent(
      ...
      if (null === workInProgress.stateNode) {
        _instance = emptyContextObject;
        state = Component.contextType;
        "contextType" in Component &&
          null !== state &&
          (void 0 === state || state.$$typeof !== REACT_CONTEXT_TYPE) &&
          ...
          (lane =
            void 0 === state
              ...
              : "object" !== typeof state
                ? " However, it is set to a " + typeof state + "."
                : state.$$typeof === REACT_CONSUMER_TYPE
        ...
        "object" === typeof state &&
          null !== state &&
          (_instance = readContext(state));
        _instance = new Component(nextProps, _instance);
      ...
      lane || state
        ? ((lane = workInProgress.stateNode),
          ...
          state && "function" !== typeof Component.getDerivedStateFromError
    ...
    exports.create = function (element, options) {
      ...
      var createNodeMock = JSCompiler_object_inline_createNodeMock_1022,
